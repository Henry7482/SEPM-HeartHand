...
const CheckoutPage = () => {
    ...
    const [selectedOrganizationWards, setSelectedOrganizationWards] =
        useState(0);
    ...
    const [organizationPhoneNumber, setorganizationPhoneNumber] =
        useState(null);
    ...
    const handleSubmit = (event) => {
        ...
        if (
            !senderPhoneNumber.startsWith("09") ||
            !organizationPhoneNumber.startsWith("09")
        ) {
            alert("Phone numbers must start with '09'");
            return;
        }

        if (
            senderPhoneNumber.length !== 10 ||
            organizationPhoneNumber.length !== 10
        ) {
        ...
        if (selectedSenderWards === 0) {
            alert("Please select sender ward");
            return;
        }
        ...
        if (selectedOrganizationWards === 0) {
            alert("Please select organization ward");
            return;
        }
    ...
    const checkTotalMass = () => {
        if (totalmass < minRequiredMass) {
            alert(
                `Total mass must be equal or greater than ${minRequiredMass}`
            );
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-md-8 col-sm-10 offset-lg-0 offset-md-2 offset-sm-1">
                                    <div className="mobile h5">
                                        Shipping Address
                                    </div>
                                    <div
                                        id="details"
                                        className="bg-white rounded pb-5"
                                    >
                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        onChange={
                                                            handleSelectOrganizationProvince
                                                        }
                                                        required
                                                    >
                                                        <option
                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        onChange={
                                                            handleSelectOrganizationDistricts
                                                        }
                                                        required
                                                    >
                                                        <option
